...
// onscroll appear content

$(window).scroll(function() {
    if ($(this).scrollTop()>400)
     {
        $('#scroll_appear_1').show(1000);
     }
    else
     {
      $('#scroll_appear_1').hide(1000);
     }
      if ($(this).scrollTop()>600)
     {
        $('#scroll_appear_2').show(1000);
     }
    else
     {
      $('#scroll_appear_2').hide(1000);
     }
      if ($(this).scrollTop()>700)
     {
        $('#scroll_appear_3').show(1000);
     }
    else
     {
      $('#scroll_appear_3').hide(1000);
     }
 });

// slide_sroll_transition

  AOS.init();

// overview_features
$('.owl-carousel.ovrview_feacture').owlCarousel({
    loop:true,
    margin:10,
...
// single-about-slide
$('.owl-carousel.single-about-slide').owlCarousel({
    loop:true,
    margin:10,
    responsiveClass:true,
    responsive:{
...
// Initialize the media query
 ...
 // toggle_appear_unappear
 $('#appear').click(function() {
    $('#unappear').css('display','block');
    $('#unappear_2').css('display','block');
    $('#mb-toggle').css('margin-bottom','60px');
  if ($('#appear').text() == "Read more") {
    $(this).text("Read less").click(function(){
        $('#unappear').css('display','none');
        $('#unappear_2').css('display','none');
        $('#mb-toggle').css('margin-bottom','0px');
    });
  } else {
    $(this).text("Read more").click(function(){
        $('#unappear').css('display','block');
        $('#unappear_2').css('display','block');
        $('#mb-toggle').css('margin-bottom','60px');
    });
...
function createTextAnimation() {
  var geometry = generateTextGeometry('COMING SOON', {
    size:14,
    height:0,
    font:'droid sans',
    weight:'bold',
